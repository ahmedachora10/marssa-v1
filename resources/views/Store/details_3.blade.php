...
.review-block-description{
   ...
   .quantity_counter {
    ...
    @endif
    <div class="container mb-3 bg-white shadow-sm" style="padding-top:80px;">
               <style>
                  .select-custom {
                  display: inline-block;
                  cursor: pointer;
                     ...
                     <div id="big" class="owl-carousel owl-theme">
                                ...
                                @foreach($product->image as $img)
                                    ...
                                    @if(in_array($getlast,['jpg','jpeg','svg','png','gif','webp']))
                                        <div class="item" style="height:100%"><img src="{{asset($img)}}" style="height: 100%;"></div>
                                    @else
                     ...
                     <div class="container">
                        ...
                        <div class="d-flex flex-nowrap p-2" >
                           <div class="text-white  btn-lg bg-light px-3" >
                              ...
                              <h3 class="mb-0 btn" style="color:black">
                                  @if($offer ?? false)
                           ...
                           @endif
                            ...
                            <del class="px-2 text-secondary " style='margin-top: 10px;color:red !important;text-decoration:line-through'>{{ $product->price_before }} </del>
                            @endif
                            @endif
                        ...
                        <div class="row p-2 align-items-center">
                           ...
                           <div class="row p-2" >
                              ...
                              <a onclick="addToCart('{{$product->id}}','{{ $product['name_'.app()->getLocale()] }}',{{$product->price}},'checkout')"  class="btn btn-danger btn-block btn-lg  background_buy_now_button" >
                               ...
                               <!---
                              <div class="col-lg-6 col-12 px-1 w-100 mb-2" >
                                 <button type="submit" id="addToCart" onclick="addToCart('{{$product->id}}','{{ $product['name_'.app()->getLocale()] }}',{{$product->price}},'checkout')"  class="btn btn__checkout px-4 py-2 xs-hidden shadow-sm  btn-block text-nowrap" >اشتري الان  <i class="fa fa-truck" style="color: #005a3c;"></i></button>
                              </div>-->
