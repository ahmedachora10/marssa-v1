...
.imgAdd
{
  ...
  font-size:15px;
   ...
   <span><a href="{{ route('dashboard.admin.slider.index')}}" class="btn btn-default ">  
    ...
    <div class="container">
        <div class="row">
        <form method="post" enctype="multipart/form-data" action="{{ route('dashboard.admin.slider.save_slider') }}" accept-charset="UTF-8">
        @csrf
        <div class="form-group">
          ...
          <input type="text" name="link" class="form-control"> 
            ...
            <div class="col-sm-6 imgUp">
                ...
                <div class="form-group">
                 <button type="submit"  class="btn btn-success uplaodbtn" > {{ __('store.upload_image') }}</button>
                </div>
            </div>
            <!-- col-2 -->
        </div>
