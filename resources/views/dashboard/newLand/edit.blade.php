    ...
    <div class="row small-spacing">
        <div class="col-xs-12">
            <div class="box-content bordered primary ">
                <form action="{{route('dashboard.admin.landing_pages.update',$offer->id)}}" method="POST">
                    @method('put')
                    @csrf
                        ...
                        <div class="@if(count($language) == 3) col-md-4 @endif col-xs-12">
                            <div class="form-group  @error('name__$lang') has-error @enderror">
                                ...
                                <input required id="name_{{$lang}}" name="name_{{$lang}}" type="text" class="form-control"
                                       value="{{ $offer["name_$lang"] ?? old('name_$lang')}}" placeholder="{{ __('master.offer_name') . ' (' . __('master.'.$lang ).')'}}  "/>
                                @error('name_$lang')
                                ...
                                <textarea required type="text" class="form-control "
                                       id="content_{{$lang}}"  name="content_{{$lang}}"
                                        placeholder="{{__('master.offer_desc')  . ' (' . __('master.'.$lang ).')'}}" rows="3"
                                        >{{$offer["content_$lang"] ??  old('content_$lang')}}</textarea>
                                @error('content_$lang')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group  @error('price') has-error @enderror">
                                ...
                                <input required id="price" name="price" type="text" class="form-control"
                                       value="{{  $offer->price}}" placeholder="{{ __('master.offer_price') }}1"/>
                                @error('price')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  @error('price_notice') has-error @enderror">
                            ...
                            <input required id="price_notice" name="price_notice" type="text" class="form-control"
                                   value="{{  $offer->price_notice}}" placeholder="{{ __('master.price_notice') }} 1"/>
                            @error('price_notice')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  @error('price1') has-error @enderror">
                            ...
                            <input  id="price1" name="price1" type="text" class="form-control"
                                   value="{{  $offer->price1}}" placeholder="{{ __('master.offer_price') }} 2"/>
                            @error('price1')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  @error('price_notice1') has-error @enderror">
                            ...
                            <input  id="price_notice1" name="price_notice1" type="text" class="form-control"
                                   value="{{  $offer->price_notice1}}" placeholder="{{ __('master.price_notice') }} 2"/>
                            @error('price_notice1')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group  @error('price2') has-error @enderror">
                            ...
                            <input  id="price2" name="price2" type="text" class="form-control"
                                   value="{{  $offer->price2}}" placeholder="{{ __('master.offer_price') }} 3"/>
                            @error('price2')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group  @error('price_notice2') has-error @enderror">
                            ...
                            <input  id="price_notice2" name="price_notice2" type="text" class="form-control"
                                   value="{{  $offer->price_notice2}}" placeholder="{{ __('master.price_notice') }} 3"/>
                            @error('price_notice2')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  @error('price3') has-error @enderror">
                            ...
                            <input  id="price3" name="price3" type="text" class="form-control"
                                   value="{{  $offer->price3}}" placeholder="{{ __('master.offer_price') }} 4"/>
                            @error('price3')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  @error('price_notice3') has-error @enderror">
                            ...
                            <input  id="price_notice3" name="price_notice3" type="text" class="form-control"
                                   value="{{  $offer->price_notice3}}" placeholder="{{ __('master.price_notice') }} 4"/>
                            @error('price_notice3')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  @error('price_notice4') has-error @enderror">
                            ...
                            <input  id="price_notice4" name="price_notice4" type="text" class="form-control"
                                   value="{{  $offer->price_notice4}}" placeholder="{{ __('master.price_notice') }} 5"/>
                            @error('price_notice4')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group  @error('desc') has-error @enderror">
                                    ...
                                    placeholder="{{ __('master.desc') }}" rows="3">{{  $offer->desc}}</textarea>
                                    @error('desc')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group  @error('notes') has-error @enderror">
                                    ...
                                    placeholder="{{ __('master.offer_notes') }}" rows="3">{{  $offer->notes}}</textarea>
                                    @error('notes')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group  @error('status') has-error @enderror">
                                ...
                                <div class="switch primary margin-top-3">
                                    <input type="checkbox" name="status" id="status"
                                           value="1"
                                           @if($offer->status==1)checked @endif>
                                    <label for="status" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group  @error('btn_text') has-error @enderror">
                                ...
                                <input  id="btn_text" name="btn_text" type="text" class="form-control"
                                       value="{{ $offer->btn_text ?? old('btn_text')}}" placeholder="{{ __('master.btn_text') }}"/>
                                @error('btn_text')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group  @error('pay_text') has-error @enderror">
                                ...
                                <input  id="pay_text" name="pay_text" type="text" class="form-control"
                                       value="{{ $offer->pay_text ?? old('pay_text')}}" placeholder="{{ __('master.pay_text') }}"/>
                                @error('pay_text')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group  @error('delivery_text') has-error @enderror">
                                ...
                                <input  id="delivery_text" name="delivery_text" type="text" class="form-control"
                                       value="{{  $offer->delivery_text ?? old('delivery_text')}}" placeholder="{{ __('master.delivery_text') }}"/>
                                @error('delivery_text')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group  @error('notice_text') has-error @enderror">
                                ...
                                <input  id="notice_text" name="notice_text" type="text" class="form-control"
                                       value="{{  $offer->notice_text ?? old('notice_text')}}" placeholder="{{ __('master.notice_text') }}"/>
                                @error('notice_text')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group @error('image') has-error @enderror">
                                    ...
                                    <div class="card-content">
                                        @include("dashboard.components.fileUploadDzone",['product'=>$offer?? []])
        ...
        <div class="col-md-12 col-xs-12">
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('dashboard.admin.landing_pages.featured_image')}}" method="post" 
                        ...
                        <form action="{{ route('dashboard.admin.landing_pages.remove_image')}}" method="post" style="padding-bottom: 10px;padding-top: 10px;margin-left: 5px;margin-right: 5px;">
                            @csrf
                            @method('post')
                            <input type="hidden" value="{{$offer->id}}" name="id">
            ...
            <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="@if(!empty($offer->featured_image )){{ asset($offer->featured_image)}} @else https://semantic-ui.com/images/wireframe/image.png @endif" alt="" class="img-fluid" style="width: 100%;height: 200px;">
                        <form action="{{ route('dashboard.admin.landing_pages.featured_image')}}" method="post" style="padding-bottom: 10px;padding-top: 10px;">
                            @csrf
                            <input type="hidden" value="{{$offer->id}}" name="id">
