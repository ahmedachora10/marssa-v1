...
@section('content')
    ...
    <div class="col-xs-12">
        <div class="col-md-12 col-xs-12">
            <form id="add_category" method="post" action="{{ $route }}" autocomplete="off"
                ...
                <div class="row">
                    <div class="col-xs-12 box-content">
                        ...
                        <div class="form-group  @error('name_ar') has-error @enderror col-md-6">
                            <label>{{__('master.name')}}</label>
                            <input type="text" class="form-control" value="{{ old('name_ar')}}"
                                   name="name_ar">
                            @error('name_ar')
                        ...
                        <div class="form-group  @error('name_fr') has-error @enderror col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ old('name_fr')}}"
                                   name="name_fr">
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
