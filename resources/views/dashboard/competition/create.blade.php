...
@section('content')
    ...
    <div class="col-xs-12">
        <div class="row">
            <form method="post" action="{{route('dashboard.merchant.competitions.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-xs-12 box-content">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-select form-control condition_type" name="condition_type">
                                  <option value="buy_products">{{ __('master.buy_products') }}</option>
                                  <option value="visit_link">{{ __('master.visits_links') }}</option>
                                </select>
                                @error('condition')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            ...
                            <!-- ------------------------------------------------------------------------- -->
                                ...
                                <!-- ------------------------------------------------------------------------- -->
                                <!-- ------------------------------------------------------------------------- -->
                                <div class="form-group col-md-12" id="buy_products">
                                ...
                                <!-- ------------------------------------------------------------------------- -->
                                <!-- ------------------------------------------------------------------------- -->
                                <div class="form-group col-md-12" id="visit_link" style="display:none">
                             ...
                             <div class="form-group col-md-12">
                                ...
                                <textarea type="text" class="form-control" value="{{old('prize')}}" name="prize"></textarea>
                                @error('prize')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
    ...
    Dropzone.options.dpzMultipleFiles = {
        ...
        init: function() {
            @if (isset($event) && $event->document)
                ...
                $('form').append('<input type="hidden" name="thumbnails[]" value="' + file.file_name + '">')
                }
            @endif
        }
    }
