...
.imgAdd
{
  ...
  font-size:15px;
   ...
   <span><a href="{{ route('dashboard.admin.color.index')}}" class="btn btn-default ">  
    ...
    <div class="container">
        <div class="row">
        <form method="post" enctype="multipart/form-data" action="{{ route('dashboard.admin.color.update_color') }}" accept-charset="UTF-8">
        @csrf
        <div class="form-group">
           <input type="hidden" name="id" value="{{ $color->id}}" class="form-control"> 

          <input type="text" name="color_ar" placeholder="اللون باللغة العربية" class="form-control" value="{{$color->color_ar}}"  required/>

          <input type="text" name="color_en" placeholder="اللون باللغة الانجليية" class="form-control" value="{{$color->color_en}}"  required/>

          <input type="text" name="color_fr" placeholder="اللون باللغة الفرنسية" class="form-control" value="{{$color->color_fr}}"  required/>
