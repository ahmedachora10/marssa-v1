                                ...
                                <div class="col-md-3 col-xs-12">
                                    <form method="POST" action="{{ route('dashboard.admin.invoices.update') }}">
                                        ...
                                        <div class="form-group  @error('status') has-error @enderror">
                                            ...
                                            <input type="radio" name="status" value="1" @if($invoice->status == 1) checked @endif>
                                            ...
                                            @endif </label>
                                             ...
                                             <input style="margin-right:100px;" type="radio" name="status" value="2" @if($invoice->status == 2) checked @endif>
                                            <label> @if(app()->getLocale() == 'ar' )
