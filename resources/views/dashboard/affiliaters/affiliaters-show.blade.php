                            ...
                            @if($affiliters)
                                @forelse($affiliters as $affiliter)
                                    <tr class="text-center">
                                        <td>{{ $affiliter->id }}</td>
                                        <td class="">
                                           {{ $affiliter->affiliaters->name ?? null }}
                                        </td>
                                        <td class="">
                                           {{ $affiliter->affiliaters->email ?? ($affiliter->affiliaters->name ?? null)  }}
                                        </td>
                                        <td class="">
                                           {{ $affiliter->affiliaters()->count() ?? 0  }}
                                        </td>
                                        <td class="">
                                        ...
                                        <td class="">
                                           <a href="{{ url('dashboard/admin/affiliater/'.($affiliter->affiliaters->id ?? null)) }}" class="btn btn-info"> {{ __('master.more_details') }}</a>
                                        </td>
