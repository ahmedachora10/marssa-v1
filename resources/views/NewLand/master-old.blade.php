...
<head>
    ...
    <link rel="stylesheet" id="wp-block-library-rtl-css" href="{{asset('newLand/css/style-rtl.min.css')}}" type="text/css" media="all">
    ...
    <link rel="stylesheet" id="classic-theme-styles-css" href="{{asset('newLand/css/classic-themes.min.css')}}" type="text/css"
        media="all">
    ...
    <link rel="stylesheet" id="elementor-icons-css" href="{{asset('newLand/css/elementor-icons.min.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="elementor-frontend-legacy-css" href="{{asset('newLand/css/frontend-legacy-rtl.min.css')}}"
        type="text/css" media="all">
    <link rel="stylesheet" id="elementor-frontend-css" href="{{asset('newLand/css/frontend-rtl.min.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="elementor-post-20-css" href="{{asset('newLand/css/post-20.css')}}" type="text/css" media="all">
    <link rel="stylesheet" id="elementor-post-10988-css" href="{{asset('newLand/css/post-10988.css')}}" type="text/css" media="all">
    ...
    <script type="text/javascript" src="{{asset('newLand/js/jquery.min.js')}}" id="jquery-core-js"></script>
...
<body 
    class="rtl page-template page-template-elementor_canvas page page-id-10988 unselectable tg-site-layout--right tg-container--wide has-page-header has-breadcrumbs elementor-default elementor-template-canvas elementor-kit-20 elementor-page elementor-page-10988 e--ua-blink e--ua-chrome e--ua-webkit"
