            ...
            <div class="elementor-section-wrap">
                                        ...
                                        <div class="elementor-element elementor-element-4494baf7 elementor-widget elementor-widget-image"
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <img decoding="async" width="950" style="height: 749px;"
                                                        height="550" src=src="@if(!empty($product->featured_image) )
                                                ...
                                                {{asset($product->firstImage())}}
                                                     ...
                                                     @endif" data-src="{{asset('newLand/img/1.jpg')}}"
                                                        ...
                                                        data-srcset="@if(!empty($product->featured_image) )
                                                         {{ asset($product->featured_image) }}
                                                @elseif(!empty($product->firstImage()))
                                                {{asset($product->firstImage())}}
                                                         @else https://semantic-ui.com/images/wireframe/image.png
                                                     @endif 950w, @if(!empty($product->featured_image) )
                                                         {{ asset($product->featured_image) }}
                                                @elseif(!empty($product->firstImage()))
                                                {{asset($product->firstImage())}}
                                                         @else https://semantic-ui.com/images/wireframe/image.png
                                                     @endif 300w,@if(!empty($product->featured_image) )
                                                         {{ asset($product->featured_image) }}
                                                @elseif(!empty($product->firstImage()))
                                                {{asset($product->firstImage())}}
                                                         @else https://semantic-ui.com/images/wireframe/image.png
                                                     @endif 768w"
                                                        ...
                                                        srcset="@if(!empty($product->featured_image) )
                                                         {{ asset($product->featured_image) }}
                                                @elseif(!empty($product->firstImage()))
                                                {{asset($product->firstImage())}}
                                                         @else https://semantic-ui.com/images/wireframe/image.png
                                                ...
                                                <div class="elementor-text-editor elementor-clearfix">
                                                    ...
                                                    <div style="text-align: center;" data-id="72bb94b1"
                                                        ...
                                                        <div>
                                                            ...
                                                            @if(!empty($land_offer) && $land_offer->count() > 0)
                                                            <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                            {{ __('master.offer_price') }}</b></span>
                                                            </h5>
                                                                @if($land_offer[0]->price )
                                                                <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                                 {{ $land_offer[0]->price_notice }}    {{ $land_offer[0]->price }} {{ $product->getCurrency() }}</b></span>
                                                                    </h5>
                                                                @endif
                                                                @if($land_offer[0]->price1 )
                                                                <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                                 {{ $land_offer[0]->price_notice1 }}    {{ $land_offer[0]->price1 }} {{ $product->getCurrency() }}</b></span>
                                                                    </h5>
                                                                @endif
                                                                @if($land_offer[0]->price2 )
                                                                <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                                 {{ $land_offer[0]->price_notice2 }}    {{ $land_offer[0]->price2 }} {{ $product->getCurrency() }}</b></span>
                                                                    </h5>
                                                                @endif
                                                                @if($land_offer[0]->price3 )
                                                                <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                                 {{ $land_offer[0]->price_notice3 }}    {{ $land_offer[0]->price3 }} {{ $product->getCurrency() }}</b></span>
                                                                    </h2>
                                                                @endif
                                                                @if($land_offer[0]->price4 )
                                                                <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                                 {{ $land_offer[0]->price_notice4 }}    {{ $land_offer[0]->price4 }} {{ $product->getCurrency() }}</b></span>
                                                                    </h5>
                                                                @endif
                                                            @else
                                                            <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;"><b>
                                                            {{ $product->price }} {{ $product->getCurrency() }}</b></span>
                                                            </h5>
                                                            @endif
                                                            @if(!empty($land_offer[0]->desc))
                                                            <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;">    <b>
                                                             {{ $land_offer[0]->desc }}</b></span>
                                                            </h5>
                                                            @else
                                                            <h5 style="margin-bottom: 1px;margin-top: 1px;padding-top: 1px;padding-bottom: 1px;">
                                                                    <span style="color: #17a617;">    <b>
                                                             {{ $product->quantity }}</b>
                                                            <b>{{ __('store.product_available') }}</b></span>
                                                            </h5>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="elementor-element elementor-element-52f61638 elementor-button-align-stretch elementor-widget elementor-widget-form"
                                            ...
                                            <div class="elementor-widget-container">
                                                <form class="elementor-form" method="post" id="shampoGrayH"
                                                    name="شامبو طبيعي لإزالة الشيب_.site"> <input type="hidden"
                                                        name="post_id" value="10988"> <input type="hidden"
                                                        name="form_id" value="52f61638"> <input type="hidden"
                                                        name="referer_title" value="SoapGhair"> <input type="hidden"
                                                        name="queried_id" value="10988">
                                                    <div class="elementor-form-fields-wrapper elementor-labels-above">
                                                        ...
                                                        <div
                                                            ...
                                                            <label for="form-field-email" class="elementor-field-label">
                                                                ...
                                                                name="phone" id="phone" placeholder="{{__('master.phone')}}"
                                                                class="elementor-field elementor-size-sm  elementor-field-textual"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="elementor-field elementor-select-wrapper ">
                                                                <select name="form_fields[field_81d535e]"
                                                                    id="form-field-field_81d535e"
                                                                    class="elementor-field-textual elementor-size-sm"
                                                                    required="required" aria-required="true">
                                                                    @if(!empty($land_offer) && $land_offer->count() > 0 )
                                                                        @if(!empty($land_offer[0]->price) && !empty($land_offer[0]->price_notice))
                                                                        <option value="{{$land_offer[0]->price}}"> {{ $land_offer[0]->price .' '}}{{' __ '. $land_offer[0]->price_notice}} </option>
                                                                        @endif
                                                                        @if(!empty($land_offer[0]->price1) && !empty($land_offer[0]->price_notice1))
                                                                        <option value="{{$land_offer[0]->price1}}"> {{ $land_offer[0]->price1 .' '}}{{' __ '. $land_offer[0]->price_notice1}} </option>
                                                                        @endif
                                                                        @if(!empty($land_offer[0]->price2) && !empty($land_offer[0]->price_notice2))
                                                                        <option value="{{$land_offer[0]->price2}}"> {{ $land_offer[0]->price2 .' '}}{{' __ '. $land_offer[0]->price_notice2}} </option>
                                                                        @endif
                                                                        @if(!empty($land_offer[0]->price3) && !empty($land_offer[0]->price_notice3))
                                                                        <option value="{{$land_offer[0]->price3}}"> {{ $land_offer[0]->price3 .' '}}{{' __ '. $land_offer[0]->price_notice3}} </option>
                                                                        @endif
                                                                        @if(!empty($land_offer[0]->price4) && !empty($land_offer[0]->price_notice4))
                                                                        <option value="{{$land_offer[0]->price4}}"> {{ $land_offer[0]->price4 .' '}}{{' __ '. $land_offer[0]->price_notice4}} </option>
                                                                        @endif
                                                                    @else
                ...
                <hr style="width: -webkit-fill-available;">
                                        ...
                                        <div class="elementor-element elementor-element-131f4be3 elementor-widget elementor-widget-image"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-image"> <img decoding="async" width="600"
                                                        height="600" src="{{asset('newLand/img/image-ad.jpeg')}}"
                                                        data-src="{{asset('newLand/img/image-ad.jpeg')}}"
                                                        class="attachment-large size-large lazyload" alt=""
                                                        data-srcset="{{asset('newLand/img/image-ad.jpeg')}} 600w, {{asset('newLand/img/image-ad.jpeg')}} 300w, {{asset('newLand/img/image-ad.jpeg')}} 150w"
                                                        sizes="(max-width: 600px) 100vw, 600px"><noscript><img
                                                            decoding="async" width="600" height="600"
                                                            src="{{asset('newLand/img/image-ad.jpeg')}}"
                                                            class="attachment-large size-large lazyload" alt=""
                                                            srcset="{{asset('newLand/img/image-ad.jpeg')}} 600w, {{asset('newLand/img/image-ad.jpeg')}} 300w, {{asset('newLand/img/image-ad.jpeg')}} 150w"
                                                            sizes="(max-width: 600px) 100vw, 600px" /></noscript></div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-icon-box-wrapper">
                                                    ...
                                                    <div class="elementor-icon-box-content">
                                                        ...
                                                        {{__('master.Paiement_when_receiving')}}
                                                            </span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="elementor-element elementor-element-507ff8c8 elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-icon-box-wrapper">
                                                    ...
                                                    <div class="elementor-icon-box-content">
                                                        <h3 class="elementor-icon-box-title"> <span> توصيل سريع خلال 3/1
                                                                ايام </span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="elementor-element elementor-element-49759fb1 elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-icon-box-wrapper">
                                                    ...
                                                    <div class="elementor-icon-box-content">
                                                        <h3 class="elementor-icon-box-title"> <span>{{__('master.guaranteed_results')}}
                                                            </span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="elementor-element elementor-element-6ce0a858 elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-icon-box-wrapper">
                                                    ...
                                                    <div class="elementor-icon-box-content">
                                                        <h3 class="elementor-icon-box-title"> <span> الدفع عند الاستلام
                                                            </span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="elementor-element elementor-element-507ff8c8 elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-icon-box-wrapper">
                                                    ...
                                                    <div class="elementor-icon-box-content">
                                                        <h3 class="elementor-icon-box-title"> <span>{{__('master.delivery')}} </span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="elementor-element elementor-element-49759fb1 elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-icon-box-wrapper">
                                                    ...
                                                    <div class="elementor-icon-box-content">
                                                        <h3 class="elementor-icon-box-title"> <span> نتائج مضمونة
                                                            </span></h3>
                                                    </div>
                                                </div>
                                            </div>
